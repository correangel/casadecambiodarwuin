...
function calculate() {
  ...
  if (select.value === "2") {
    ...
    result5.value =
      "$" + valresult5dolarprom + " / " + "€" + valresult5europrom;
    result4.value =
      "$" + valresult4dolarprom + " / " + "€" + valresult4europrom;
    result3.value =
      "$" + valresult3dolarprom + " / " + "€" + valresult3europrom;
    result2.value =
      "$" + valresult2dolartrans + " / " + "€" + valresult2eurotrans;
  ...
  if (select.value === "1") {
    ...
    result2.value = "BsF. " + valresult2dolarefec;
    result3.value = "BsF. " + valresult3dolarprombol;
    result4.value = "BsF. " + valresult4dolarprombol;
    result5.value = "BsF. " + valresult5dolarprombol;
  }
  if (select.value === "3") {
    result5title.value = dolartoday._labels.e + ":";
    result4title.value = dolartoday._labels.d + ":";
    ...
    result2title.value = dolartoday._labels.b + ":";
    resulttitle.value = dolartoday._labels.a + ":";
    result.value = "BsF. " + valresulteurotrans;
    result2.value = "BsF. " + valresult2euroefec;
    result3.value = "BsF. " + valresult3europrombol;
    result4.value = "BsF. " + valresult4europrombol;
    result5.value = "BsF. " + valresult5europrombol;
  }
  if (select.value === "4") {
